...
export default function ExternalHomeView() {
  ...
  const allActualDepartments = [
    ...
    },
    {
      ...
      subName: "Basic Technical Skills",
      levels: ["ปวช.", "ปวส."],
      skills: ["งานฝึกฝีมือและช่างพื้นฐาน", "งานตะไบและงานโลหะเบื้องต้น", "งานเขียนแบบเทคนิค", "ความปลอดภัยในงานอุตสาหกรรม"],
      icon: "build",
      badge: "ทักษะช่างพื้นฐาน",
      desc: "จัดการเรียนการสอนเสริมสร้างทักษะช่างพื้นฐาน งานฝึกฝีมือ เครื่องมือกล และมาตรฐานความปลอดภัยในการปฏิบัติงาน",
    },
    {
      id: "general",
      name: "แผนกวิชาสามัญสัมพันธ์",
      subName: "General Education & Applied Sciences",
      levels: ["ปวช.", "ปวส."],
      skills: ["ภาษาเพื่อการสื่อสารและการทำงาน", "วิทยาศาสตร์และคณิตศาสตร์ประยุกต์", "การคิดวิเคราะห์และแก้ปัญหา", "ทักษะชีวิตและการทำงานร่วมกัน"],
      icon: "menu_book",
      badge: "หมวดวิชาสามัญและทักษะชีวิต",
      desc: "พัฒนาทักษะวิชาการพื้นฐาน ภาษา การสื่อสาร วิทยาศาสตร์ประยุกต์ และทักษะชีวิตเพื่อเตรียมความพร้อมสู่การทำงานจริง",
    },
    {
      id: "energy",
          ...
          <div className="relative hidden md:block">
            ...
            <div className="grid grid-cols-2 gap-md">
              <div className="bg-surface border border-outline-variant p-md rounded-2xl shadow-sm mt-lg space-y-2">
                ...
                <div className="text-[11px] text-on-surface-variant">ครอบคลุม 20 แผนกวิชาช่างและเทคโนโลยี วิทยาลัยเทคนิคหาดใหญ่</div>
              </div>
