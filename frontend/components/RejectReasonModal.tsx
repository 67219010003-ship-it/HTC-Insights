...
export default function RejectReasonModal({
  ...
  return (
    ...
    >
      <div className="bg-white border border-rose-100 rounded-3xl p-6 md:p-8 max-w-md w-full shadow-2xl space-y-5 animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
        {/* Header */}
